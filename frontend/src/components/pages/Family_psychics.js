...
const Family_psychics = () => {
  ...
  <div className="caption">
    <h4>Family & Relationship Psychics</h4>
    <p>Family psychics can answer questions and give love advice! Will I find love? Will I marry? Is he cheating? What will happen with my divorce?</p>
  </div>
</div>
...
export default Family_psychics;
