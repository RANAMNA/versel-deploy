...
import breakup from '../Images/breakup.jpeg';
...
const Break_up = () => {
  ...
  <img src={breakup} alt="love banner"/>
  <div className="caption" >
    <h4 style={{marginLeft:'100px'}}>
        <br/> 
        <strong style={{fontSize:'2em', color:'white', fontStyle:'italic'}}> Breaking Up & Divorce</strong>
    </h4>
           ...
           <div className="product-box">
             <div className="product-main">
               ...
               <div className="intro" data-aos="fade-right">
                 <span>
                 Is it over? Sometimes one door closes in order for another to open. Find out what new beginnings are coming for you in life with a psychic reading today.</span> </div>
               <br></br>
