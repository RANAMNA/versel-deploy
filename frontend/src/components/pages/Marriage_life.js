...
import marital from '../Images/marital.PNG';
...
const Marriage_life = () => {
  ...
  <img src={marital} alt="love banner"/>
  <div className="caption" >
    <h4 style={{marginLeft:'100px'}}>
        <br/> 
        <strong style={{fontSize:'2em', color:'white', fontStyle:'italic'}}>Marital Life</strong>
    </h4>
           ...
           <div className="product-box">
             <div className="product-main">
               ...
               <div className="intro" data-aos="fade-right">
                 <span>
                 Your marriage started with a fairytale beginning, but will it lead to happily ever after? A psychic reader can help you discover the secrets to keeping your marriage healthy, happy, and passionate, so get a marriage psychic reading today!</span> </div>
               <br></br>
