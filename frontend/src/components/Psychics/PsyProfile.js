...
Money & Finance</p>
            ...
            <a href="#" className="btn btn-block" style={{background:'#ff6000', color:'#fff'}}><b><Link to="Update_profile"> <span className='text-white'>Update Profile </span></Link> </b></a>
          </div>
          {/* /.card-body */}
        </div>
        {/* /.card */}
        ...
        <div className="card">
          <div className="card-header" style={{background:'#ff6000'}}>
            <h3 className="card-title"> <span className='text-white'>About Me </span></h3>
          </div>
          {/* /.card-header */}
...
Crystals</p>
            <hr />
            <strong style={{color:'#636363'}}><i className="fas fa-flag -alt mr-1" /> Coutry/State</strong>
            
             <p className='text-muted'>USA Californiia</p>
            
            <hr />
            <strong style={{color:'#636363'}}><i className="fas fa-file-alt mr-1 " /> Abilities</strong>
