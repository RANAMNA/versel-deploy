...
import paypal from '../Admin/payment/paypal.jpeg';
...
const Psy_History = () => {
  return (
    ...
    <a href="javascript:void(0)" className="btn btn-sm btn-info float-left"> <Link to="/psychics/pages/chatlive"><span className='text-white'>Go Live</span> </Link> </a>
  </div>
      {/* Content Header */}
...
<div className="card">
  ...
  <h3 className="card-title"><span className='text-white'>Banned Users</span></h3>
    <div className="card-tools">
      <button type="button" className="btn btn-tool" data-card-widget="collapse">
        <i className="fas fa-minus" />
      </button>
      ...
      <table className="table m-0">
        ...
        <tbody>
          <tr>
            ...
            <td>Arolnad</td>
            <td><span className="badge badge-warning">Warn</span></td>
            <td>
          ...
          <tr>
            ...
            <td>
              <div className="sparkbar" data-color="#f39c12" data-height={20}>Time Wasted</div>
            </td>
          </tr>
          <tr>
            <td><a href="">OR9842</a></td>
  ...
  <div className='col-md-6'>
    ...
    <div className="card">
      <div className="card-header">
      <h3 className="card-title"><span className='text-white'> Payment Cleared</span></h3>
        <div className="card-tools">
