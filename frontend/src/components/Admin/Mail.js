  ...
  <div className="row">
    <div className="col-md-3">
      ...
      <div className="card">
        <div className="card-header">
          <h3 className="card-title"><span className='text-white'>Folders</span></h3>
          ...
          <ul className="nav nav-pills flex-column">
            <li className="nav-item active">
              <a href="#" className="nav-link">
                <i className="fas fa-inbox text-gray" /> Inbox
            ...
            <li className="nav-item">
              <a href="#" className="nav-link">
                <i className="fas fa-filter text-gray" /> Junk
                <span className="badge bg-warning float-right">65</span>
              </a>
            </li>
            <li className="nav-item">
              <a href="#" className="nav-link">
                <i className="far fa-trash-alt text-gray"/> Trash
              </a>
            </li>
          </ul>
        </div>
      ...
      <div className="card">
        <div className="card-header">
          <h3 className="card-title"><span className='text-white'>Labels</span></h3>
          <div className="card-tools">
            <button type="button" className="btn btn-tool" data-card-widget="collapse">
              <i className="fas fa-minus text-white" />
            </button>
    ...
    <div className="col-md-9">
      <div className="card card-primary card-outline">
        <div className="card-header">
          <h3 className="card-title"> <span className='text-white'>Inbox</span></h3>
          <div className="card-tools">
            ...
            <table className="table table-hover table-striped">
              <tbody>
                <tr>
                  ...
                  <td className="mailbox-name"><a href="read-mail.html"> <Link to= "/admin/pages/Read_mail"><Link to= "/admin/pages/Read_mail">Alexander Pierce</Link></Link></a></td>
                  <td className="mailbox-subject"><b>Talktospychics 3.0 Issue</b> - Trying to find a solution to this problem...
                  </td>
                ...
                <tr>
                  ...
                  <td className="mailbox-name"><a href="read-mail.html"><Link to= "/admin/pages/Read_mail">Alexander Pierce</Link></a></td>
                  <td className="mailbox-subject"><b>Talktospychics 3.0 Issue</b> - Trying to find a solution to this problem...
                  </td>
